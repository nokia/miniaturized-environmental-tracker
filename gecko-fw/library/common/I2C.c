...
uint8_t I2C_Read_Debug(uint8_t slv_addr, uint8_t reg_addr, uint8_t *reg_data, uint16_t len) {
    ret_code_t err_code;
...
uint8_t I2C_Write_Debug(uint8_t slv_addr, uint8_t reg_addr, uint8_t *reg_data, uint16_t len) {
